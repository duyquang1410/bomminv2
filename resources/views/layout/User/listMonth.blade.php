                    ...
                    <div class="row wrapper white-bg page-heading">
                        <div class="col-lg-9">
                          <div class="row">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12 hidden">
                                    <div class="listMonthYear">
                                        ...
                                        <div class="">
                                            @for($monthYear=1;$monthYear<=12;$monthYear++)
                                                <span><a href="{!! route('users.listMonthYear', ['month'=>$monthYear, 'year'=>'2022']) !!}" class="btn btn-xs @if($monthYear==$month && $year =='2022') active @endif" title="">{!! !empty($monthYear)?$monthYear:0 !!}</a></span>
                                            @endfor
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                            <h2>Danh sách đi hát , đi bay <span style="background: #f8ac59; padding: 0px 10px; border-radius: 4px;color: #FFF;">{!! !empty($month)?$month:date('m') !!} / {!! !empty($year)?$year:date('Y') !!} </span></h2>
                            @endif
                            ...
                            <div class="list-date-month">
                                <div class="head-date">
                                 ...
                                 <div class="list-time" id="listDateDay">
                                     ...
                                     for($i=1;$i<=31;$i++){
                                     ?>
                                     <div class="item-time" id="item-time"><a class="@if(!empty($id) && $id == $i) active @endif" href="{!! route('users.listDayMonthYear', ['day'=>$i, 'month'=>$month, 'year'=>$year]) !!}" title="" class="">{!! $i !!}</a></div>
                                     <?php
                                     }
                                     ?>
                                 </div>
