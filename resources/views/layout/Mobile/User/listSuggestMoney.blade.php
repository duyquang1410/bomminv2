                        ...
                        @if(!empty($data))
                            ...
                            <div class="item-suggest">
                                ...
                                <div class="info-suggest">
                                    <h4>Số tiền cần ứng : <span><b>{!! !empty($items['numberMoney'])?number_format($items['numberMoney'], 0):0 !!}</b> VND</span></h4>
                                    ...
                                    <div class="month"><b>Tháng ứng</b> : {!! !empty($items['month'])?$items['month']:'' !!} / {!! !empty($items['year'])?$items['year']:'' !!}</div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <form id="frmsuggestMoney" method="POST">
                    ...
                    <div class="note" style="padding: 10px;"><span style="color: red;">Ghi chú : Tháng ứng sẽ là tháng được trừ vào lương của tháng đó , và chỉ được ứng lương trước khi thanh toán tháng lương đó ( Sau thanh toán sẽ không được ứng )</span></div>
                </form>
            </div>
                                ...
                                success: function (data, textStatus, xhr) {
                                    ...
                                    if(data['message']=='success'){
                                        ...
                                        Lobibox.notify('warning', {
                                            title: 'Thông báo',
                                            msg: 'Tháng đó bạn đã được thanh toán, không được ứng lương tháng đã thanh toán !',
                                            delay: 5000
                                        });
                                    }
                                    else {
